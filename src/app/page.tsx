...
export default function Home() {
  ...
  async function understandEvent() {
    ...
    try {
      ...
      const result = await response.json() as { kind?: unknown; classification?: { eventId?: unknown; facts?: unknown } };
      ...
      if (!response.ok || result.kind !== "classified" || !nextScenario || !parsedContext.success) {
        setError("I’m not yet sure which supported event this is. Please choose “I’m expecting a child” or “I lost my job,” or describe it a little differently.");
        return;
      }
