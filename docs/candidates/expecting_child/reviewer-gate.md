...
- [x] Human review decision recorded on 2026-07-17: **Approved with scope:
  ...
  it does not approve a runtime pack.
...
| `ec_piba_birth_registry_procedure` | Project owner (worktree directive) | 2026-07-17 | `approved` with scope | Routine birth in an Israeli hospital only; hospital notice is distinct from registry entry. |
