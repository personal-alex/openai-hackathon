...
export const expectingChildTransitionFixture = {
  ...
  tasks: [
    ...
    },
    {
      ...
      actionSummary: "For the scoped routine-hospital fixture, and only where the newborn is eligible for Population Registry entry, the hospital submits the birth notice and the Population and Immigration Authority completes the entry. This does not establish automatic Israeli-ID receipt.",
      priority: 2,
